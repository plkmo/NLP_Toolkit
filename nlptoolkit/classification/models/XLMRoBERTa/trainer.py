...
def train_and_fit(args):
    ...
    net = XLMRobertaForSequenceClassification.from_pretrained('xlm-roberta-base', num_labels=args.num_classes)
    if cuda:
        net.cuda()
    ...
    '''
    logger.info("FREEZING MOST HIDDEN LAYERS...")
    unfrozen_layers = ["classifier", "roberta.pooler", "roberta.encoder.layer.11", \
