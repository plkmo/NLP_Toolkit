# -*- coding: utf-8 -*-
"""
Adapted from https://github.com/soaxelbrooke/python-bpe/blob/master/bpe/encoder.py
"""
...
class Encoder:
    ...
    def __init__(self, vocab_size=8192, pct_bpe=0.2, word_tokenizer=None,
                 ...
                 EOW=DEFAULT_EOW, SOW=DEFAULT_SOW, UNK=DEFAULT_UNK, PAD=DEFAULT_PAD, SOS=DEFAULT_SOS,\
                 EOS=DEFAULT_EOS):
        if vocab_size < 1:
        ...
        self.SOS = SOS
        self.EOS = EOS
        self.required_tokens = [self.UNK, self.PAD, self.SOS, self.EOS]
