...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_encoder_len", type=int, default=120, help="Max src length")
    parser.add_argument("--max_decoder_len", type=int, default=120, help="Max trg length")
    ...
    src_input, trg_input, trg2_input, src_mask, trg_mask, trg2_mask, labels, labels2 = train_and_fit(args)