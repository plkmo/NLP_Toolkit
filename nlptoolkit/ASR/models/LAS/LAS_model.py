...
class LAS(nn.Module):
    def __init__(self, listener_input_size, listener_hidden_size, output_class_dim, max_label_len = 100):
        ...
        self.max_label_len = max_label_len
        self.listener = Listener(listener_input_size, listener_hidden_size)
    ...
    def forward(self, x, trg_input, infer=False):
        ...
        x = x.permute((0,2,1)); # x = batch_size X seq_len X features
        x = self.listener(x)
